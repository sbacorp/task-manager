	...
	return (
		<div className="relative">
			<input
				ref={inputRef}
				type="text"
				className="w-[300px] rounded bg-black border border-solid border-gray6 px-10 py-3 hover:border-gray4  focus:border-gray3 focus:border transition-all duration-300 font-serif text-lg"
				value={value}
