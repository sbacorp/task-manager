				...
				<Dialog.Portal>
					...
					<Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[80vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-dark9 p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none z-50 border border-solid">
						...
						<div className="flex flex-col gap-3">
							...
							/>
							<span className='inline-block cursor-pointer font-semibold outline-none text-sm text-white text-center border-4 bg-cyan7 rounded py-[10px] px-[20px] hover:bg-cyan9'>Выберите файл</span>
							</label>
							<p>{message}</p>
						</div>
