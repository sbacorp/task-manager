...
const SignIn = () => {
  ...
  const [signType, setSignType] =
    useState<LoginType>('signin');
  ...
  const handleResetPassword = async (
    ...
    setMessage(
      'Ссылка для сброса пароля отправлен на вашу почту.'
    );
    router.push('/');
  };
    ...
    <SignLayout>
      {signType === 'signin' ? (
        <div className="flex flex-col gap-7 font-serif items-center">
          <p className="text-white font-normal text-22 mt-3">
            Вход
          </p>
          <form
          ...
          >
            <div className="flex flex-col gap-3">
              <p className="text-dark text-center">
                Вы можете восстановить свой пароль
                здесь
              </p>
