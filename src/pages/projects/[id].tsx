...
function Project() {
    const router = useRouter(), {id} = router.query, dispatch = useAppDispatch(), projects = useAppSelector((state) => {
        return state.projectsSlice.projects;
    }), project = projects.find((b) => b.id == id), [loading, setLoading] = useState(true);
